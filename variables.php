...
/*
$Emails['emails']['ep@ALBADRPLUS.net'] = [
'balance'=>100,
'sold_balance'=>200
];
...
$Home['my_info']['bot_name'] = '𓆩ᯓ𝘼𝙇𝘽𝘼𝘿𝙍 𝙋𝙇𝙐𝙎 |𝙎𝙈𝙎| البدر بلسᯓ𓆪 ';
$Home['my_info']['channel']    = '@HACKERBADR';
$Home['accounts'][$id]['email'] = 'ep@jALBADRPLUS.net';
